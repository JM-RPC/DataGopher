...
The "Plot Data" button, much as the name suggests, makes various plotting capabilities drawn from matplotlib and seaborn available (and resides in the file goPlot.py). 
