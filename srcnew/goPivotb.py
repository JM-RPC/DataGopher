...
class goPivot(tk.Toplevel):
    def __init__(self):
        ...
        self.row_widget = lw.goList(self.fw,TEXT = "Row Categories:", CHOICES = colnames)
        ...
        self.col_widget = lw.goList(self.fw,TEXT = "Columns Categories:", CHOICES = colnames)
        ...
        #highjact the red close button to clean u pand close using exit_close()
    ...
    def syncData(self,*arg):
        #synchronize with gdata and update menu choices
        if len(gdata.data) > 0:
            ...
            self.pivFrame.do_display(PT = gdata.data)
        return
